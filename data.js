const ticketData = [
  {
    ...
    "updatedDate": "2026-06-30T19:33:46+08:00",
  ...
  },
  {
    ...
    "progress": "方案4(录屏分析)✅ 方案5(SKU测算)✅ | 方案2/6/7逾期 | 方案1/3进行中",
    "penalty": {
      "amount": 1200,
  ...
  },
  {
    ...
    "progress": "0/2 完成：🔴 建立任务清单，关键信息2小时内响应：培训... | 🔴 组长每周检查周考执行状态：各组长每周检查...",
    "penalty": {
      "amount": 1200,
      "basis": "监管反馈: ¥+1000 | 影响加成: ¥+200",
      "status": "calculated",
  ...
  },
  {
    ...
    "progress": "方案1/2/3已逾期；方案4截止日今日(6/30)进行中",
    "penaltyAmount": null,
    "penaltyConfirmed": false,
    "penaltyConfirmedBy": null,
    "penaltyConfirmedAt": null,
  ...
  },
  {
    ...
    "progress": "3/3 完成：✅ 知识储备摸底 ✅ 人员评估是否汰换 ✅ 漏放原因定位",
    "manualPenalty": null,
    "penaltyConfirmed": false,
    "penaltyConfirmedBy": null,
    "penaltyConfirmedAt": null
  },
  {
    ...
    "updatedDate": "2026-06-30T19:33:46+08:00",
    "summary": "得物用户资料审核，昵称「富平都敏俊」涉1号内容漏放。业务id：2586844374，工单id：193199908。扣罚1000元。",
    "impact": "🟡 中等 | 个例漏判反馈",
    "rootCause": "案例于2025-06-06进入高危通道，聂明月（已离职）和钱紫玉未拦截。钱紫玉知晓对应违规点但对案例无印象。关键词库中缺少「富平」未覆盖。",
    "solutions": [
      {
        "step": 1,
        "action": "漏放原因定位：钱紫玉知违规点但无印象+关键词库缺「富平」",
        "owner": "牛欢欢",
        "deadline": "2026-06-29",
        "status": "done"
      },
      {
        "step": 2,
        "action": "涉一号内容培训：全员当面验证+关键词库持续完善更新",
        "owner": "牛欢欢",
        "deadline": "2026-07-01",
        "status": "done"
      },
    ...
    "timeline": [
      ...
      {
        "time": "06/29 18:16",
        "event": "牛欢欢提交复盘：根因定位+全员验证+关键词更新+紧急回查"
      },
      {
        "time": "06/29 18:19",
        "event": "钱燕确认扣罚1000元"
    ...
    "progress": "全部已完成。原因定位（钱紫玉知违规点但无印象+关键词未覆盖）✅ 涉一号培训（全员当面验证+关键词更新）✅ 数据回扫（各通道紧急回查）✅",
    "manualPenalty": null,
    "penaltyConfirmed": false,
    "penaltyConfirmedBy": null,
    "penaltyConfirmedAt": null
  },
  {
    ...
    "createdDate": "2026-06-29",
    "updatedDate": "2026-06-30T19:33:46+08:00",
    "summary": "审核超时等5条内容误伤/漏放，客户发起横向负反馈。涉及：微信号漏打标、违规内容未拦截、高危通道漏放、专项通道超时。",
    "impact": "🟡 中等 | 客户横向负反馈",
    "rootCause": "1.王博：昵称「新盛公司dhr9989」+车头像，理解为无广告交易意图，未搜微信号→漏打标\n2.李月月：背景赌博网站+头像色情网站，OCR/机审均有提示但无印象→流程执行不到位\n3.买鹏程/张鼎：背景FLG违规，高危通道未拦截，机审OCR均有提示→在班状态及流程存疑\n4.王博：专项通道关闭期间进审，理解错误未及时关注→超时扣罚",
    "solutions": [
      {
        "step": 1,
        "action": "漏放原因定位",
      ...
      {
        "step": 2,
        "action": "提升标签打标准确性（通晒学习+流程重申+状态监控+通道澄清）",
        "owner": "牛欢欢",
        "deadline": "2026-07-04",
        "status": "done"
      }
    ...
    "timeline": [
      ...
      {
        "time": "06/29 18:58",
        "event": "牛欢欢提交完整复盘：4起案例原因定位及5项改善举措"
      },
      {
        "time": "06/30 14:49",
        "event": "钱燕确认完结"
    ...
    "progress": "全部已完成。原因定位✅ 改善举措已落地：案例通晒学习、操作流程重申、在班状态监控、通道逻辑澄清。",
    "manualPenalty": null,
    "penaltyConfirmed": false,
    "penaltyConfirmedBy": null,
    "penaltyConfirmedAt": null
  },
  {
    ...
    "updatedDate": "2026-06-30T19:33:46+08:00",
    "summary": "审核执行「苏芒」舆情指令时，未结合指令具体拦截要求，对涉及「启境+该人物」的内容误判删除。通告群无法通过关键词「苏芒」定位指令，仅能通过「女仆」定位，存在指令传达与解读问题。",
    "impact": "🟡 内容误删，影响平台内容完整性\n🟡 指令传达与解读流程存在漏洞\n🟡 关键词定位不统一，审核效率受影响",
    "rootCause": "审核知晓舆情指令涉及人物事件，看到相关描述时从严管控导致误删，未结合指令拦截要求确认；指令通告关键词覆盖不全（仅定位「女仆」未同步「苏芒」）",
    "solutions": [
      {
        "step": 1,
        "action": "定位误伤前后原因，确认指令误删根因",
        "owner": "黎俊",
        "deadline": "2026-06-30",
        "status": "done"
      },
    ...
    "timeline": [
      {
        "time": "06/30 10:02",
        "event": "朱莹发现舆情指令误删，要求回查"
      },
      {
        "time": "06/30 10:04",
        "event": "黎俊确认根因：指令涉及启境和人物导致从严误删"
      },
      {
        "time": "06/30 10:20",
        "event": "黎俊完成近一月数据回扫，修改9条"
      },
      {
        "time": "06/30 10:53",
        "event": "明确后续管控要求：先查看拦截要求再执行"
      },
      {
        "time": "06/30 14:23",
        "event": "钱燕发起会议，梳理舆情问题流程"
      },
      {
        "time": "06/30 14:30",
        "event": "会议召开，确认后续优化方向"
      ...
      {
        "time": "06/30 15:41",
        "event": "王世亚报告方案2(复盘培训+录屏)和方案3(通宵班录屏监控)已完成"
      }
    ],
    "tags": [
      "舆情",
    ...
    "progress": "方案1(回扫)已完成。方案2(复盘培训+录屏)已完成。方案3(通宵班录屏监控)已完成。方案4(培训5天)进行中。方案5(班前提醒)持续中。方案6(整体排查)待启动。",
    "manualPenalty": null,
    "penaltyConfirmed": false,
    "penaltyConfirmedBy": null,
    "penaltyConfirmedAt": null
  },
  {
    ...
    "createdDate": "2026-06-30",
    "updatedDate": "2026-06-30T19:33:46+08:00",
    "summary": "商汤近期客户反馈案例中，针对低俗导向内容审核尺度不明确的问题，需汇总同类型案例做整体拉齐；同时对组内人员进行摸底，确保人员尺度执行一致，避免因标准不一导致客户投诉。\n\n参考文档：https://docs.popo.netease.com/lingxi/e8d36196362a42feabfff441fe0e559e",
    "impact": "🟡中等影响\n- 低俗导向内容审核尺度不统一，可能导致客户投诉\n- 组内人员执行标准不一致，存在质量隐患\n- 需系统性拉齐，影响审核质量和客户满意度",
    "rootCause": "1. 低俗导向内容审核尺度缺乏统一明确判定标准\n2. 组内人员对低俗内容的认知和执行尺度存在差异\n3. 缺少同类型案例汇总及培训拉齐机制",
    "solutions": [
      {
        "step": 1,
        "action": "汇总商汤近期客户反馈中的同类型低俗导向案例",
        "owner": "杨珂珂",
        "deadline": "T+2",
        "status": "in_progress"
      },
    ...
    "timeline": [
      {
        "time": "06/30 16:48",
        "event": "杨珂珂发起工单，背景：商汤客户反馈低俗导向尺度问题"
      }
    ],
    "tags": [
      "低俗导向",
    ...
    "progress": "方案已分配，推进中。方案1-2(杨珂珂)：案例汇总+尺度文档；方案3-4(杨珂珂)：人员摸底+专项培训",
    "penaltyConfirmed": false
  },
  {
    "id": "TK-2026-022",
    "title": "河南诺达信息科技-商汤-低俗导向尺度拉齐与人员摸底",
    "author": "杨柯柯",
    "vendor": "河南诺达信息科技",
    "status": "open",
    "priority": "P1",
    ...
    "createdDate": "2026-06-30",
    "updatedDate": "2026-06-30T19:33:46+08:00",
    "summary": "商汤项目近期收到客户低俗导向相关反馈案例。当前低俗导向内容尺度不明确，需汇总同类型案例做整体拉齐，同时对组内人员执行尺度进行摸底，确保一致性。",
    "impact": "低俗导向尺度不统一可能导致审核结果不一致、客户投诉升级，影响项目交付质量。",
    "rootCause": "低俗导向内容判定标准不够细化，组内人员对尺度理解存在偏差。",
    "solutions": [
      {
        "step": 1,
        "action": "汇总近期商汤客户反馈的低俗导向案例，形成案例库",
        "owner": "杨柯柯",
        "deadline": "T+3",
        "status": "in_progress"
      },
    ...
    "timeline": [
      {
        "time": "06/30 17:54",
        "event": "杨柯柯发起工单，背景为商汤客户近期反馈低俗导向案例，需尺度拉齐与人员摸底"
      }
    ],
    "tags": [
      "商汤",
    ...
    "progress": "方案已分配并推进中：案例汇总(T+3)、尺度对齐(T+5)、摸底考核(T+7)、细则文档(T+10)",
    "penaltyConfirmed": false
  },
  {
    "id": "TK-2026-020",
    "title": "河南诺达Keep安审涉色情/领导人案例漏放",
    "author": "X",
    "vendor": "河南诺达信息科技",
    "status": "overdue",
    "priority": "P0",
    ...
    "createdDate": "2026-06-26",
    "updatedDate": "2026-06-30T19:33:46+08:00",
    "summary": "Keep安审线发生高风险内容漏放，涉及色情内容及领导人形象相关案例，属于双重红线违规。\n\n群内讨论显示近期漏放频发，除人员问题外需关注项目整体质量。",
    "impact": "🔴重大影响\n- 涉政漏放（领导人案例）+ 涉色情漏放，双重红线违规\n- 直接影响平台内容安全合规",
    "rootCause": "1. 审核人员对涉政/涉色情案例敏感度不足\n2. 通宵班人员监控机制缺失（录屏覆盖问题）\n3. 缺乏有效实时预警和拦截机制\n4. 项目整体质量管控存在系统性漏洞（漏放频发）",
    "solutions": [
      {
        "step": 1,
        "action": "回扫全量数据，排查同类漏放",
        "owner": "王世亚",
        "deadline": "T+0",
        "status": "done"
      },
      {
        "step": 2,
        "action": "线下1对1/1对2复盘培训，覆盖全员（含通宵班录屏）",
        "owner": "王世亚",
        "deadline": "T+1",
        "status": "overdue"
      },
    ...
    "timeline": [
      {
        "time": "06/26 14:05",
        "event": "张思语通知赵培育，要求拉管理进群"
      },
      {
        "time": "06/26 14:09",
        "event": "张思语指出漏放频发，要求看项目整体问题"
      },
      {
        "time": "06/26 14:10",
        "event": "赵培育确认知悉，表示内部沟通规避"
      },
      {
        "time": "06/27 08:48",
        "event": "闫媛媛跟进回扫记录"
      ...
      {
        "time": "06/29 10:51",
        "event": "王世亚说明复盘计划：线下1对1/1对2 + 录屏，15-16点"
      },
      {
        "time": "06/29 11:01",
        "event": "闫媛媛提出通宵班录屏监控 + 5天培训覆盖问题"
      },
      {
        "time": "06/29 11:04",
        "event": "王世亚确认通宵班为质量头部人员，本周可覆盖全员"
      }
    ],
    "tags": [
      "涉政漏放",
    ...
    "progress": "✅方案1:回扫全量数据，排查同类漏放 | 🔴方案2:线下1对1/1对2复盘培训，覆盖全员（含 | 🔴方案3:建立通宵班录屏监控机制 | 🟡方案4:连续线下培训5天，全员覆盖 | 🟡方案5:每周班前重点提醒涉政/色情案例 | 🟡方案6:排查项目整体质量问题（漏放频发）",
    "penaltyConfirmed": false
  }
];
